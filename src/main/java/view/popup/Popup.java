...
import view.window.WindowDressingUtility;
import view.window.WindowTitleBarColorUtility;
...
//TODO: Convert this to using Extended stage style. Setup default fallback to what it is now though.
public class Popup {
